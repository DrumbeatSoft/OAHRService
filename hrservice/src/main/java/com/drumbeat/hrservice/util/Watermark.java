...
/**
 * @ProjectName: Drumbeat.OA.APP
 * @Package: com.drumbeat.baselib.base
 * @ClassName: Watermark
 * @Description:
 * @Author: 王宇
 * @CreateDate: 2019/11/8 16:14
 */
public class Watermark {
     ...
     * 显示水印，铺满整个view
     *
     * @param rootView 铺满整个view
     * @param text     水印
     */
    @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN)
    public void show(ViewGroup rootView, String text) {
     ...
     */
    @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN)
    public void show(View rootView, String text) {
        if (TextUtils.isEmpty(text)){
            return;
        }
        WatermarkDrawable drawable = new WatermarkDrawable();
