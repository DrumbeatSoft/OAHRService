...
public class OkHttpUtil {
     ...
     * @param netCall
     */
    public void upload(String url, String hrToken, MultipartBody.Part[] files, final NetCall netCall) {
    ...
    private RequestBody setRequestBody(Map<String, String> BodyParams) {
        ...
        if (BodyParams != null) {
            ...
            while (iterator.hasNext()) {
                ...
                LogUtils.debug("post http", "post_Params===" + key + "====" + BodyParams.get(key));
            }
        }
